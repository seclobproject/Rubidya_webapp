    ...
    <div className="w-full h-full  ">
      ...
      <div className=" w-full flex flex-row">
        ...
        <div className="sticky w-full flex justify-center  gap-3 mt-2 ">
          <div className="hidden lg:flex h-full w-[20%] xl:w-[30%] fixed top-[105px] left-8 "><RightSideBar /></div>
          <Outlet />
          <div className=" hidden lg:flex h-full w-[20%] xl:w-[25%] fixed top-[105px] right-8 "><SuggestionBar /></div>
        </div>
      </div>

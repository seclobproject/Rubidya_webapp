...
const Signup = () => {
  ...
  return (
    ...
    //           <button className="w-full h-full" onClick={signupHandler} >{isLoading?<ClipLoader color="white" size={20}/>:"Signup"}</button>
    //         </div>
    ...
    //   </div>
    // </div>
    <div className="w-full h-[100vh] flex flex-col-reverse justify-center lg:flex-row">
